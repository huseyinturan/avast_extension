...
(() => {
  var e = {
        ...
        (i.format = function (e, t) {
          ...
          for (a = 0; a < f; a++)
            if ("string" == typeof e[a]) p += e[a];
              ...
              if (
                (s.not_type.test(d.type) &&
                  s.not_primitive.test(d.type) &&
              ...
              switch ((s.number.test(d.type) && (c = n >= 0), d.type)) {
                ...
                case "e":
                  n = d.precision
                    ? parseFloat(n).toExponential(d.precision)
                    : parseFloat(n).toExponential();
                  break;
                case "f":
                  n = d.precision
                    ? parseFloat(n).toFixed(d.precision)
                    : parseFloat(n);
                  break;
                case "g":
                  n = d.precision
                    ? String(Number(n.toPrecision(d.precision)))
                    : parseFloat(n);
                  break;
                case "o":
                ...
                case "s":
                  (n = String(n)),
                    (n = d.precision ? n.substring(0, d.precision) : n);
                  break;
                case "t":
                  (n = String(!!n)),
                    (n = d.precision ? n.substring(0, d.precision) : n);
                ...
                if (t[2]) {
                  ...
                  for (o.push(u[1]); "" !== (d = d.substring(u[0].length)); )
                    if (null !== (u = s.key_access.exec(d))) o.push(u[1]);
                      ...
                      if (null === (u = s.index_access.exec(d)))
                        throw new SyntaxError(
                          "[sprintf] failed to parse named argument key"
                        );
                      o.push(u[1]);
      ...
      6146: (e, t, n) => {
        ...
        function v(e, t) {
          for (
            var n = arguments.length, a = Array(n > 2 ? n - 2 : 0), s = 2;
            s < n;
            s++
          )
            a[s - 2] = arguments[s];
        ...
        var w = (function () {
            ...
            return (
              a(e, [
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    if (e.resources)
                      return (0, s.default)(!0, p, e), this.register_lng(e, t);
                    for (var n in e) {
                      if (n.indexOf("_") > -1 && e[n].locale_data)
                        for (var a in e[n].locale_data.messages)
                          "" == e[n].locale_data.messages[a][0] &&
                            delete e[n].locale_data.messages[a];
                      e[n.toLowerCase()] = e[n];
                    }
                    ...
                    if ((L != a || y != r) && null != r) {
                      ...
                      f.resources &&
                        ...
                        h.en &&
                          ...
                          Object.keys(h.en.locale_data.messages).forEach(
                            function (e) {
          ...
          T = (m._NITRO_LOCALIZATION = m._NITRO_LOCALIZATION
            ? m._NITRO_LOCALIZATION
            : new w());
        ...
        const i = new ((function () {
          ...
          return (
            ...
            (e.prototype.create = function (t) {
              return new e(
                this.logger,
                a({ prefix: this.prefix + ":" + t + ":" }, this.options)
              );
            }),
            e
          );
        ...
        const x = (function (e) {
          ...
          return (
            ...
            (t.prototype.extractFromKey = function (e, t) {
              ...
              if (n && e.indexOf(n) > -1) {
                var s = e.split(n);
                (n !== a || (n === a && this.options.ns.indexOf(s[0]) > -1)) &&
                  (r = s.shift()),
                  (e = s.join(a));
              }
              return (
                ...
                if (t.keySeparator || this.options.keySeparator) {
                  ...
                  for (var f in _)
                    Object.prototype.hasOwnProperty.call(_, f) &&
                      (h[f] = this.translate(
                        "" + r + n + f,
                        b({}, t, { joinArrays: !1, ns: s })
                      ));
                  _ = h;
                }
              } else if (m && "[object Array]" === l)
                (_ = _.join(m)) && (_ = this.extendTranslation(_, r, t));
              else {
                var p = !1,
                  M = !1;
                if (
                  ...
                  if ("fallback" === this.options.saveMissingTo && L && L[0])
                    for (var g = 0; g < L.length; g++) y.push(L[g]);
                  else
                  ...
                  this.options.saveMissing &&
                    (this.options.missingKeyHandler
                      ...
                      : this.backendConnector &&
                        ...
                        this.backendConnector.saveMissing(y, i, r, _)),
            ...
            (t.prototype.extendTranslation = function (e, t, n) {
              ...
              this.options.interpolation.defaultVariables &&
                (r = b({}, this.options.interpolation.defaultVariables, r)),
                        ...
                        u.forEach(function (r) {
                          if (!t.isValidLookup(a)) {
                            ...
                            o && (_ = t.pluralResolver.getSuffix(r, n.count)),
                              ...
                              o && u.push((i += _));
                            for (var l = void 0; (l = u.pop()); )
                              t.isValidLookup(a) ||
                                (a = t.getResource(r, e, l, n));
                          }
                        });
                    });
                  }
            ...
            (e.prototype.getSuffix = function (e, t) {
              ...
              if (a) {
                ...
                this.options.simplifyPluralSuffix &&
                  ...
                  (2 === s ? (s = "plural") : 1 === s && (s = ""));
                var i = function () {
                  return n.options.prepend && s.toString()
                    ? n.options.prepend + s.toString()
                    : s.toString();
                };
          ...
          return (
            (e.prototype.init = function () {
              ...
              t &&
                ...
                (this.escape =
                  (e.interpolation && e.interpolation.escape) || p)),
              ...
              (this.escapeValue = void 0 === n.escapeValue || n.escapeValue),
                ...
                (this.nestingPrefix = n.nestingPrefix
                  ? h(n.nestingPrefix)
                  : n.nestingPrefixEscaped || h("$t(")),
                (this.nestingSuffix = n.nestingSuffix
                  ? h(n.nestingSuffix)
                  : n.nestingSuffixEscaped || h(")")),
                this.resetRegExp();
            }),
            ...
            (e.prototype.nest = function (e, t) {
              ...
              for (
                ...
                "string" != typeof r && (r = d(r)),
                  r ||
                    (this.logger.warn(
                      "missed to resolve " + a[1] + " for nesting " + e
                    ),
                    (r = "")),
                  (e = e.replace(a[0], r)),
                  (this.regexp.lastIndex = 0);
              ...
              this.read(s, i, "read", null, null, function (a, r) {
                a &&
                  ...
                  !a &&
                    r &&
                    t.logger.log(
                      n + "loaded namespace " + i + " for language " + s,
                      r
                    ),
                  t.loaded(e, a, r);
              });
          ...
          return (
            ...
            (t.prototype.init = function (e, t) {
              ...
              if (
                ...
                this.modules.logger
                  ? i.init(a(this.modules.logger), this.options)
                ...
                (s.logger = i),
                  ...
                  (s.cacheConnector = new Q(
                    a(this.modules.cache),
                    s.resourceStore,
                    s,
                    this.options
                  )),
            ...
            (t.prototype.getFixedT = function (e, t) {
              ...
              return (
                "string" == typeof e ? (a.lng = e) : (a.lngs = e), (a.ns = t), a
              );
            }),
                ...
                if (null !== e)
                  if (d && e.forEach === d) e.forEach(t, n);
                    ...
                    for (a = 0, r = e.length; a < r; a++)
                      if (a in e && t.call(n, e[a], a, e) === u) return;
                  } else
                    for (s in e)
                      if (o.call(e, s) && t.call(n, e[s], s, e) === u) return;
              },
              extend: function (e) {
                return (
            ...
            _.extend(l.prototype, {
              ...
              dcnpgettext: function (e, t, n, a, r) {
                ...
                if (((a = a || n), (e = e || this._textdomain), !this.options))
                  return (s = new l()).dcnpgettext.call(
                    s,
                    void 0,
                    void 0,
                    n,
                ...
                return !(i = m[u]) || d > i.length
                  ? (this.options.missing_key_callback &&
                      this.options.missing_key_callback(u, e),
                    (o = [n, a]),
                    this.options.debug,
                    o[c()(r)])
                  : (o = i[d]) || (o = [n, a])[c()(r)];
                  ...
                  for (s = 0; s < c; s++)
                    if ("string" === (m = e(n[s]))) h.push(n[s]);
                      ...
                      switch ((null == r && (r = ""), o[8])) {
                        ...
                        case "s":
                          r =
                            (r = String(r)) && o[7] ? r.substring(0, o[7]) : r;
                          break;
                        case "u":
                          r = Math.abs(r);
                          break;
            ...
            (l.PF.interpreter = function (e) {
              return function (t) {
                switch (e.type) {
                  ...
                  case "TERNARY":
                    return l.PF.interpreter(e.expr)(t)
                      ? l.PF.interpreter(e.truthy)(t)
                      : l.PF.interpreter(e.falsey)(t);
                  case "OR":
                    return (
                      l.PF.interpreter(e.left)(t) ||
                      l.PF.interpreter(e.right)(t)
                    );
                  case "AND":
                    return (
                      l.PF.interpreter(e.left)(t) &&
                  ...
                  case "LT":
                    return (
                      l.PF.interpreter(e.left)(t) < l.PF.interpreter(e.right)(t)
                    );
                  case "GT":
                    return (
                      l.PF.interpreter(e.left)(t) > l.PF.interpreter(e.right)(t)
                  ...
                  for (var c, m, h, f, p, M, y, L, g, Y, k = {}; ; ) {
                    if (
                      ...
                      this.defaultActions[h]
                        ? (f = this.defaultActions[h])
                        : (null == c && (c = l()), (f = s[h] && s[h][c])),
      ...
      1278: function (e, t, n) {
        !(function (e) {
          ...
          function t(e, t, n) {
            return (
              e + " " + r({ mm: "munutenn", MM: "miz", dd: "devezh" }[n], e)
            );
          }
          function n(e) {
            switch (a(e)) {
        ...
        (e = n.nmd(e)).exports = (function () {
          ...
          function F(e) {
            for (var t, n, a, r, s = 0; s < e.length; ) {
              for (
                t = (r = E(e[s]).split("-")).length,
                  n = (n = E(e[s + 1])) ? n.split("-") : null;
                t > 0;
          ...
          function $(e, t) {
            return function (n) {
              return null != n
                ? (B(this, e, n), a.updateOffset(this, t), this)
                : q(this, e);
            };
          }
          function q(e, t) {
          ...
          function re(e) {
            ...
            for (t = 0, n = a.length; t < n; t++)
              te[a[t]] ? (a[t] = te[a[t]]) : (a[t] = ae(a[t]));
            return function (r) {
              var s = "";
              for (t = 0; t < n; t++)
                s += a[t] instanceof Function ? a[t].call(r, e) : a[t];
              return s;
            };
          }
          function se(e, t) {
          ...
          function ie(e, t) {
            ...
            for (X.lastIndex = 0; n >= 0 && X.test(e); )
              (e = e.replace(X, a)), (X.lastIndex = 0), (n -= 1);
            return e;
          }
          var oe = /\d/,
            de = /\d\d/,
          ...
          function Ge(e, t) {
            return s(this._months)
              ...
              : this._months[Ie.test(t) ? "format" : "standalone"][e.month()];
          }
          ...
          function Ke(e) {
            return null != e
              ? (Be(this, e), a.updateOffset(this, !0), this)
              : q(this, "Month");
          }
          function Ze() {
          ...
          function Xe(e) {
            return this._monthsParseExact
              ? (d(this, "_monthsRegex") || nt.call(this),
          ...
          function nt() {
            ...
            for (a.sort(e), r.sort(e), s.sort(e), t = 0; t < 12; t++)
              (a[t] = Se(a[t])), (r[t] = Se(r[t])), (s[t] = Se(s[t]));
          ...
          function wt(e) {
            if (e._f !== a.ISO_8601) {
              ...
              var t,
                ...
                u = 0;
              for (
                r = ie(e._f, e._locale).match(Q) || [], t = 0;
                t < r.length;
                t++
              )
                (s = r[t]),
                  (n = (o.match(we(s, e)) || [])[0]) &&
                    ...
                    (u += n.length)),
                  te[s]
                    ? (n ? (c(e).empty = !1) : c(e).unusedTokens.push(s),
                      Pe(s, n, e))
                    : e._strict && !n && c(e).unusedTokens.push(s);
            ...
            return (
              ...
              null === t || (void 0 === n && "" === t)
                ...
                : ("string" == typeof t && (e._i = t = e._locale.preparse(t)),
                  g(t)
                    ? new L(at(t))
                    : (s(n) ? St(e) : n ? wt(e) : i(t) ? (e._d = t) : Pt(e),
                      m(e) || (e._d = null),
                      e))
            );
          }
          ...
          function Qt() {
            return (
              this._tzm
                ...
                : "string" == typeof this._i && this.utcOffset(Gt(ge, this._i)),
              this
            );
          }
          function Xt(e) {
          ...
          function Ln(e, t) {
            ...
            return (
              ...
              ("millisecond" === (t = G(f(t) ? "millisecond" : t))
                ? +this > +n
          ...
          function An(e) {
            ...
            return void 0 === e
              ? this._locale._abbr
              : (null != (t = R(e)) && (this._locale = t), this);
          }
          ...
          function ya(e) {
            ...
            return null != e
              ? ((e = _a(e, this.localeData())), this.add(e - t, "d"))
              : t;
          }
          function La(e) {
            if (!this.isValid()) return null != e ? this : NaN;
          ...
          function Rr(e, t) {
            return (
              void 0 !== Nr[e] && (void 0 === t ? Nr[e] : ((Nr[e] = t), !0))
            );
          }
          function Jr(e) {
  ...
  (n.d = (e, t) => {
    ...
    (() => {
      ...
      var O,
        A = (O = /[^.]+$/.exec((P && P.keys && P.keys.IE_PROTO) || ""))
          ? "Symbol(src)_1." + O
          : "";
      const E = function (e) {
        return !!A && A in e;
      ...
      const ee = function (e, t) {
        ...
        return (
          ...
          (n[e] = $ && void 0 === t ? "__lodash_hash_undefined__" : t),
          this
        );
      };
      function te(e) {
      ...
      (te.prototype.clear = q),
        (te.prototype.delete = B),
        (te.prototype.get = Z),
        (te.prototype.has = X),
        (te.prototype.set = ee);
      const ne = te;
      ...
      (Ye.prototype.clear = he),
        (Ye.prototype.delete = Me),
        (Ye.prototype.get = ye),
        (Ye.prototype.has = Le),
        (Ye.prototype.set = ge);
      const ke = Ye;
      ...
      const Ee = function (e, t) {
        for (var n = 0, a = (t = Oe(t, e)).length; null != e && n < a; )
          e = e[Ae(t[n++])];
      ...
      const We = new (class {
        ...
        Ie = () => {
          Ne("common/ui/css/spawn.css"),
            Ne("common/ui/css/opting-out-overlay.css");
        };
      (() => {
