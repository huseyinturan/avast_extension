(() => {
                ...
                !(async function () {
                  function e(e) {
                    ...
                    return {
                      update() {
                        const t = (++a / e) * 100;
                        var n;
                        (n = Math.round(100 * t) / 100) <= 100 &&
                          ((s.data = n + "%"), (i.style.width = n + "%"));
                      },
                      destroy() {
                        t.remove();
                      },
                      ...
                      if (!e[s]) {
                        const o = i(s, n),
                          a = i(s, n, (e, t) => {
                            ...
                            const [, i, s] =
                              t("height").match(/([\d.]+)[\s]?([\w]+)/) || [];
                            e.style.height = i + 100 + s;
                          });
                        e[s] = [...t(n, o), ...t(o, a, !0)].filter(
                          (e) => !r.includes(e)
                        );
                      }
                      return e[s];
                  ...
                  async function o() {
                    ...
                    let r = t.querySelectorAll(
                      "*:not(script):not(br):not(svg)"
                    ).length;
                    const o = i(),
                      a = (function (e, t) {
                        return document.createNodeIterator(e, 1, t);
                      })(t, (e) =>
                        s.includes(e.nodeName.toLowerCase())
                          ? NodeFilter.FILTER_REJECT
                          : NodeFilter.FILTER_ACCEPT
                      ),
                      u = (function () {
                        const e = document.head.appendChild(
                    ...
                    let c = (function (e, t) {
                      ...
                      if (e.tagName && "img" === e.tagName.toLowerCase()) {
                        ...
                        (e.width = Math.round(t.width) + "px"),
                          (e.height = Math.round(t.height) + "px");
                      }
                  ...
                  function a(e) {
                    const t = [...document.querySelectorAll("link")].reduce(
                      (e, t) => (t.href && (e[t.href] = t), e),
                      {}
                    );
                  ...
                  chrome && chrome.extension
                    ? window.dump_dom_inlined ||
                      ...
                      chrome.runtime.sendMessage({
                        type: "dump",
                        data: a(document.documentElement.outerHTML),
                      }),
                      (window.dump_dom_inlined = !0))
                    : (t.exports = async () => (
                        window.dump_dom_inlined || (await u()),
                ...
                var r = {
                  CREDIT_CARD: {
                    ...
                    GIFT: {
                      ...
                      nre: new RegExp(
                        "((?:visa|mastercard|discover|amex|american express).*gift.?card)|(debit.*card)",
                        "i"
                      ),
                    },
                  },
              ...
              function (e, t, n) {
                ...
                t.exports = {
                  ...
                  mix: function (e) {
                    var t, n;
                    for (
                      e = e || function () {}, t = 1, n = arguments.length;
                      t < n;
                      t++
                    )
                ...
                (t.exports.xinputMatches = function (e, t, n, r) {
                  ...
                  (t.exports.likelyMonthSelect = function (e) {
                    ...
                    return (
                      ...
                      (-1 != n[11].value.indexOf("12") ||
                        -1 != n[11].text.indexOf("12"))
                    );
                  }),
              ...
              function (e, t, n) {
                ...
                t.exports = {
                  parentElement: function (e) {
                    ...
                    if (
                      e.parentElement &&
                      Node.prototype.contains.call(e.parentElement, e)
                    )
                      return e.parentElement;
                    if (
                      e.parentNode &&
                      1 == e.parentNode.nodeType &&
                      Node.prototype.contains.call(e.parentNode, e)
                    )
                      return e.parentNode;
              ...
              function (e, t, n) {
                ...
                function h(e) {
                  return (
                    !(
                      !e.parentElement ||
                      ((t = e.parentElement.contains),
                      "function" != typeof t) ||
                      e.parentElement.contains(e)
                    ) ||
                    c.some(function (t) {
                ...
                function m(e) {
                  ...
                  if (
                    "number" != typeof e.clientWidth ||
                    "number" != typeof e.clientHeight
                  )
                    return !1;
                  ...
                  return !(
                    n.right + window.scrollX < 0 ||
                    n.bottom + window.scrollY < 0
                  );
                }
                function f(e) {
                  if (h(e)) return !1;
                  ...
                  E = l.Class.define(
                    ...
                    },
                    {
                      ...
                      xpath: {
                        get: function () {
                          return (
                            !this._path &&
                              this._element &&
                              (this._path = this._generateXPath()),
                            this._path
                          );
                        },
                      },
                      ...
                      findParentId: function () {
                        ...
                        for (
                          var e = this._element.parentElement;
                          null != e && e != this._ancestor;
                      ...
                      addMutationListener: function (e, t) {
                        if (window.MutationObserver) {
                          ...
                          n.observe(this._element, t),
                            this._observers.push({ observer: n, listener: e });
                        }
                      },
                      removeMutationListener: function (e) {
                        for (
                          var t = 0;
                          t < this._observers.length &&
                          this._observers[t].listener != e;

                        )
                          ++t;
                        t >= this._observers.length ||
                          (this._observers[t].observer.disconnect(),
                      ...
                      addEventListener: function (e, t) {
                        if (e == l.XElement.Event.REMOVED) {
                          ...
                          n.observe(document, { childList: !0, subtree: !0 }),
                            this._observers.push({ observer: n, listener: t });
                        }
                      },
                      removeEventListener: function (e, t) {
                        e == l.XElement.Event.REMOVED &&
                          this.removeMutationListener(t);
                      },
                    },
                    {
                  ...
                  b = l.Class.derive(
                    ...
                    },
                    {
                      ...
                      _loadElements: function (e, t) {
                        var n =
                          "string" == typeof this._element.tagName &&
                        ...
                        var r =
                          ...
                          ("accounts.google.com" === window.location.hostname &&
                            (this._element.ownerDocument.querySelector(
                              'div[role="button"][tabindex="0"][id="identifierNext"]'
                            ) ||
                              this._element.ownerDocument.querySelector(
                                'div[role="button"][tabindex="0"][id="passwordNext"]'
                              ))) ||
                          this._element.querySelector("button");
                        r && (this._submit = new l.XElement(r)),
                          (this._inputs = l.XInput.copyFrom(
                            l.XElement.queryAll(e, this._element, !0)
                          ).filter(
                            function (e) {
                              return (
                                !this._submit ||
                                e._element != this._submit._element
                              );
                            }.bind(this)
                          ));
                      },
                      ...
                      _categorizeCreditCards: function () {
                        ...
                        this._inputs.forEach(function (p, m, f) {
                          if (
                            ...
                            if (
                              !s(p, i.GIFT.appliesTo, i.GIFT.re, ["text"]) ||
                              s(p, i.GIFT.appliesTo, i.GIFT.nre, ["text"])
                            )
                              if (
                                n[r.CARDHOLDER_NAME] ||
                                !s(
                                  p,
                                  i.CARDHOLDER_NAME.appliesTo,
                                  i.CARDHOLDER_NAME.re,
                                  ["text"]
                                )
                              )
                                if (
                                  n[r.SNUM] ||
                                  !s(p, i.SNUM.appliesTo, i.SNUM.re, [
                                    "text",
                                    "number",
                                    "tel",
                                    "password",
                                  ...
                                  if (
                                    n[r.CNUM] ||
                                    !s(p, i.CNUM.appliesTo, i.CNUM.re, [
                                      "text",
                                      "number",
                                      "tel",
                                    ])
                                    ...
                                    if (o(p) && !l) {
                                      ...
                                      if (g && a(g))
                                        return (
                                          ...
                                          void e.push(g, r.CARD_VALID_YEAR)
                                        );
                                    }
                                    if (
                                      s(
                                        p,
                                        i.CARD_VALID_MONTH.appliesTo,
                                        i.CARD_VALID_MONTH.re,
                                        ["text", "number", "tel"]
                                      ) &&
                                      !l
                                    ) {
                                      ...
                                      return v &&
                                        s(
                                          v,
                                          i.CARD_VALID_YEAR.appliesTo,
                                          i.CARD_VALID_YEAR.re,
                                          ["text", "number", "tel"]
                                        )
                                        ? ((l = !0),
                                          e.push(p, r.CARD_VALID_MONTH),
                                          void e.push(v, r.CARD_VALID_YEAR))
                                        : s(
                                            p,
                                            i.EXPIRE.appliesTo,
                                            i.EXPIRE.re,
                                    ...
                                    if (
                                      p.element.maxLength >= 12 ||
                                      -1 == p.element.maxLength
                                    )
                                      return (u = !0), void e.push(p, r.CNUM);
                                    for (
                                      var _ = 1;
                                      m + _ < f.length &&
                                      s(f[m + _], i.CNUM.appliesTo, i.CNUM.re, [
                                        "text",
                                        "number",
                                        "tel",
                                      ]);
                          ...
                          (t.commit = function () {
                            this.forEach(function (t) {
                              (t.xinput.category = t.category),
                                4 == t.category &&
                                  e.type == l.XForm.Type.PWDCHG &&
                                  (t.xinput.oldPassword = !0);
                            });
                          }),
                          e.inputs.find(
                            function (e) {
                              ...
                              return (
                                this._inputs.find(
                                  function (r) {
                                    r.matches(e.xpath, this._element) &&
                                      ((n = !1), t.push(r, e.category));
                                  }.bind(this)
                                ),
                                n
                              );
                      ...
                      _categorizeByInputDb: function () {
                        ...
                        return (
                          !!this._categories.find(
                            function (e) {
                              return (
                                void 0 !== e.type && this._categorizeFullForm(e)
                              );
                            }.bind(this)
                          ) ||
                          ...
                          this._categories.forEach(function (t) {
                            t.inputs &&
                              t.inputs.forEach(function (t) {
                                t.xpath &&
                                  32766 == t.type &&
                                  l.XElement.queryAll(t.xpath, e, !0).forEach(
                                    function (e) {
                      ...
                      _guessLoginInput: function () {
                        if (
                          ...
                          if (
                            1 != t.length ||
                            (t[0].hidden && 1 == e.length && !e[0].hidden)
                          )
                      ...
                      _recognize: function (e) {
                        ...
                        this._removeIgnored(t),
                          this._removeIgnored(n),
                          (this._type = l.XForm.Type.EITHER);
                        var r = !1;
                        ...
                        if (
                          ((this._type == l.XForm.Type.EITHER && r) ||
                            ...
                            !l.XElement.query(
                              ".//input[translate(@type, 'PASWORD', 'pasword') = 'password']",
                              t,
                              !0
                            ) ||
                            !l.XElement.test(
                              "count(.//input[translate(@type, 'HIDEN', 'hiden') != 'hidden']) < 5",
                              n
                            ) ||
                            (this._type = l.XForm.Type.LOGIN),
                          this._type == l.XForm.Type.PWDCHG)
                    ...
                    },
                    {
                      ...
                      _getStandaloneInputsParent: function () {
                        ...
                        for (
                          ...
                          n.length > 1 &&
                          !n[n.length - 1].id &&
                          "body" !== n[n.length - 1].tagName.toLowerCase();
                      ...
                      groupFormlessForms: function () {
                        var e = l.XElement.queryAll(
                          ".//input[@type='password' and not(ancestor::form)]",
                          null,
                          !0
                        );
                        return 0 === e.length
                          ...
                          : e
                              ...
                              .reduce(function (e, t) {
                                return 0 === e.length
                                  ? [t]
                                  : (e[e.length - 1].element !== t.element &&
                                      e.push(t),
                                    e);
                              }, []);
                      },
                      search: function (e, t) {
                        ...
                        var n = l.XForm.copyFrom(
                          l.XElement.queryAll(".//form", null, !0)
                        );
                        return (
                ...
                b.formTypeRules = {
                  "count(.//input[translate(@type, 'PASWORD', 'pasword') = 'password']) > 3":
                    b.Type.IGNORE,
                  "count(.//input[translate(@type, 'PASWORD', 'pasword') = 'password']) = 3":
                    b.Type.PWDCHG,
                  "count(.//input[translate(@type, 'PASWORD', 'pasword') = 'password']) = 2 and count(.//input[translate(@type, 'HIDEN', 'hiden') != 'hidden' and translate(@type, 'BUTON', 'buton') != 'button']) - count(.//input[translate(@type, 'SUBMIT', 'submit') = 'submit']) = 2":
                    b.Type.IGNORE,
                  "count(.//input[translate(@type, 'PASWORD', 'pasword') = 'password']) > 1":
                    b.Type.SIGNUP,
                  ...
                  "count(.//input[translate(@type, 'PASWORD', 'pasword') = 'password']) = 1":
                    b.Type.LOGIN,
                  "count(.//input[translate(@type, 'PASWORD', 'pasword') = 'password']) = 0":
                    b.Type.NONE,
                  ...
                  },
                  {
                    ...
                    label: {
                      get: function () {
                        return void 0 !== this._label
                          ? this._label
                          : this._element.id
                          ? (this._label = this._ancestor.querySelector(
                              "label[for=" +
                                u.quoteValue(this._element.id) +
                                "]"
                            ))
                          : (this._label = null);
                      },
                    ...
                    password: {
                      get: function () {
                        return (
                          ...
                          (0 == this.category &&
                            this._element.type &&
                            "password" == this._element.type.toLowerCase())
                        );
                      },
                    },
                    oldPassword: !1,
                    ...
                    newPassword: {
                      get: function () {
                        return (
                          this.category == r.NEW_PASSWD ||
                          (0 == this.category && this._newPassword)
                        );
                      },
                      set: function (e) {
                        this._newPassword = e;
                    ...
                    hidden: {
                      get: function () {
                        return (
                          (this._element.type &&
                            "hidden" === this._element.type.toLowerCase()) ||
                    ...
                    visibilityChanged: function (e) {
                      ...
                      return (
                        ...
                        void 0 === this._lastHidden[e]
                          ...
                          : t !== this._lastHidden[e] &&
                            ((this._lastHidden[e] = t), !0)
                      );
                    },
                    button: {
                      get: function () {
                        return (
                          ...
                          (this._element.type &&
                            ("button" === this._element.type.toLowerCase() ||
                              "submit" === this._element.type.toLowerCase()))
                        );
                      },
                    },
                    non_text: {
                      get: function () {
                        var e = this._element.type
                          ? this._element.type.toLowerCase()
                          : "";
                        return (
                    ...
                    email_tel: {
                      get: function () {
                        var e,
                          t = this._element.type
                            ? this._element.type.toLowerCase()
                            : "",
                          n = this._element.id
                            ? this._element.id.toLowerCase()
                            : "",
                          r = this._element.name
                            ? this._element.name.toLowerCase()
                            : "";
                        try {
                          e =
                            this._element.id &&
                    ...
                    getValue: function () {
                      return !this._element.type ||
                        ("checkbox" !== this._element.type.toLowerCase() &&
                          "radio" !== this._element.type.toLowerCase())
                      ...
                      switch (e) {
                        ...
                        case "options":
                          return Array.prototype.slice
                            .call(this._element.querySelectorAll("option"))
                            .map(function (e) {
                        ...
                        case "tagName":
                          ...
                          return "string" == typeof n
                            ...
                            : Node.prototype.cloneNode
                                .call(this._element, !1)
                                .localName.toLowerCase();
                        case "editable":
                          return (
                            !0 !== this._element.readOnly &&
                            !0 !== this._element.disabled
                          );
                        default:
            ...
            7: [
              function (e, t, n) {
                ...
                function h(e, t) {
                  ...
                  for (
                    var i = n.toLowerCase(),
                      s = Element.prototype.getElementsByTagName.call(
                        (t && t.documentElement) ||
                          t ||
                          document.documentElement,
                        "*"
                    ...
                    var c = u(
                      Element.prototype.getAttribute.call(s[l], "action")
                    );
                ...
                function d(e, t) {
                  ...
                  if (!n && !r) return null;
                  var i = Element.prototype.getElementsByTagName.call(
                  ...
                  if (n && "radio" === n.toLowerCase()) {
                    ...
                    if (l) {
                      for (
                        var c = l.toLowerCase(), h = 0, d = i.length - 1;
                        d >= 0;
                        --d
                      )
                        if (
                          u(Element.prototype.getAttribute.call(i[d], a)) ==
                            s &&
                          u(
                            Element.prototype.getAttribute.call(i[d], "value")
                          ) == c
                        ) {
                          if (h) return null;
                          h = 1;
                ...
                t.exports = {
                  generate: function e(t, n) {
                    ...
                    if (
                      t == document.body &&
                      t.parentElement == document.documentElement
                    )
                    ...
                    for (var p = []; t && t != n; t = r(t)) {
                      ...
                      if ("html" != m && "body" != m && "frameset" != m) {
                        ...
                        if ((g = c(t, A)))
                          ...
                          1 !=
                          Element.prototype.getElementsByTagName.call(
                  ...
                  (r.prototype.emit = function (e) {
                    ...
                    if (i(n))
                      switch (arguments.length) {
                        ...
                        default:
                          for (
                            r = arguments.length, a = new Array(r - 1), u = 1;
                            u < r;
                            u++
                          )
                            a[u - 1] = arguments[u];
                ...
                t.exports = {
                  ...
                  advance: function e(t, n) {
                    for (
                      var s;
                      t.length > 0 &&
                      !(s = r.XElement.query(t[0].xpath, document, !0));
                    ...
                    if (!a.target)
                      return (a.xelement = r.XInput.copyFrom(s)), a;
                      ...
                      return (
                        n &&
                          ...
                          (m = c.find(function (e) {
                            return (
                              void 0 !== e.value &&
                              e.value.toString() === n[a.target].toString()
                            );
                          })),
                        m ||
                          (m = c.find(function (e) {
                            return (
                              void 0 !== e.param && void 0 !== e.param.value
                            );
                          })),
                        m
                          ...
                          : (i.error(
                              a.xpath,
                              c.map((e) => e.xpath).join(", "),
                              "cannot match value, skipping"
                            ),
                            e(t, n))
                      );
                    }
                    ...
                    if (f.length <= 1) {
                      ...
                      return (
                        ("change" !== a.event && !a.target) ||
                          ...
                          "textarea" === g ||
                          "select" === g ||
                          ("checkbox" !== s.getProperty("role").toLowerCase() &&
                            !s.element.hasAttribute("aria-checked")) ||
                          ((a.allXElements = f),
                          (a.checkedXElement =
                            s.element.getAttribute("aria-checked") + "" ==
                            "true"
                              ? a.xelement
                              : null)),
                        a
                    ...
                    var v = f.find(function (e) {
                        return (
                          e.element.getAttribute("aria-checked") + "" == "true"
                        );
                      }),
                      _ = null;
                    return (
                      ...
                      _ ||
                        (a.param && a.param.value && (_ = f[n[a.param.value]])),
                      _
                        ? ((a.checkedXElement = v),
                          (a.xelement = r.XInput.copyFrom(_)),
                          a)
                        : v
                        ? ((a.xelement = v),
                          (a.checkedXElement = a.xelement),
                          a)
                        : (i.error(
                            a.xpath,
                            f.map((e) => e.xpath).join(", "),
                            "cannot match value, skipping"
                          ),
                          e(t, n))
                    );
              ...
              function (e, t, n) {
                ...
                function i(e, t) {
                  if (t.startsWith("mouse")) {
                    ...
                    var s, o;
                    (s = document.createEvent("HTMLEvents")).initEvent(
                      t,
                      !1,
                      !0
                    ),
                      e.dispatchEvent(s),
                      (o = document.createEvent("HTMLEvents")).initEvent(
                        t,
                        !0,
                        !0
                      ),
                ...
                t.exports = {
                  ...
                  readOnly: function e(t) {
                    return Array.isArray(t)
                      ? t.some(e)
                      : t.element.disabled || t.element.readOnly;
                  },
                  ...
                  prefillCredentials: function (e, t, n) {
                    return (
                      (!0 === n ||
                        e.type == r.XForm.Type.LOGIN ||
                        e.type == r.XForm.Type.EITHER) &&
            ...
            14: [
              function (e, t, n) {
                const r = e("./prettyArguments.js").deduplicateArguments,
                  i =
                    /(?:^|[^a-zA-Z0-9 ,.]|(?:^|[^0-9])[ ,.])[1-9][0-9][0-9]?(?:$|[^a-zA-Z0-9 ,.]|[ ,.](?:$|[^0-9]))/,
                  s =
                ...
                t.exports = function (e, t) {
                  ...
                  const h =
                      e.FIRST_NAME && e.LAST_NAME && e.MIDDLE_NAME
                        ? new RegExp(
                            e.FIRST_NAME + " ([a-zA-Zð-﻾][^ ]*) " + e.LAST_NAME,
                            "i"
                          )
                        : null,
                  ...
                  if (!m) return null;
                  e.AGE && u > a / 2 && (n.AGE = 1),
                    e.STATE_SHORT && l > a / 2 && (n.STATE_SHORT = 1),
                    e.CITY && c > a / 2 && (n.CITY = 1);
                  return Object.keys(n).reduce((e, t) => e + n[t], 0) -
                    m.score <=
                    1
                    ? m.element
                    : null;
                    ...
                    (window.app.avEvents = {
                      emitEvent(e, t) {
                        "string" == typeof t && (t = JSON.parse(t)),
                          window.NAPI._eventEmitter.emit(e, t);
                      },
                    });
                })();
              },
              ...
              function (e, t, n) {
                ...
                class i extends r {
                  ...
                  paused() {
                    return (
                      !!this.pauseTimeout &&
                      (void 0 === this.pauseValue || this.pauseValue)
                    );
                  }
                  forward(e) {
                    this.emit(e);
                ...
                (i.Event = { END: "end", CONTINUE: "continue" }),
                  (t.exports = i);
              },
              { events: 10 },
            ],
                ...
                t.exports = {
                  prettyArguments: function (e) {
                    ...
                    if (
                      ...
                      if (!isNaN(n)) {
                        var o = new Date(n);
                        (t.BIRTH_DATE_DAY = o.getDate()),
                          (t.BIRTH_DATE_MONTH = o.getMonth() + 1),
                          (t.BIRTH_DATE_YEAR = o.getFullYear());
                      }
                    }
                    if (t.STATE && t.COUNTRY && !t.STATE_SHORT)
                      r[t.COUNTRY] &&
                        r[t.COUNTRY][t.STATE] &&
                        (t.STATE_SHORT = r[t.COUNTRY][t.STATE]);
                    else if (
                      !t.STATE &&
                      t.COUNTRY &&
                      t.STATE_SHORT &&
                    ...
                    return (
                      (t.FIRST_NAME || t.LAST_NAME) &&
                        (t.FIRST_MIDDLE_LAST_NAME ||
                          (t.FIRST_MIDDLE_LAST_NAME = s()
                            .add(t.FIRST_NAME)
                            .add(t.MIDDLE_NAME)
                            .add(t.LAST_NAME)
                            .join(" ")),
                        t.FIRST_M_LAST_NAME ||
                          (t.FIRST_M_LAST_NAME = s()
                            .add(t.FIRST_NAME)
                            .add(t.MIDDLE_NAME_SHORT)
                            .add(t.LAST_NAME)
                            .join(" ")),
                        t.FIRST_LAST_NAME ||
                          (t.FIRST_LAST_NAME = s()
            ...
            20: [
              function (e, t, n) {
                ...
                if (!window.hash || window.hash !== r) {
                  (window.hash = r),
                    e("../napi.js"),
                    NAPI.request("window.setNoneClientAreas", [[0, 0, 50, 50]]);
                  ...
                  window.addEventListener("beforeunload", function () {
                    o
                      ? o.reportResult(!0)
                      : (NAPI.request("scraper.result", { status: "ok" }),
                        (a = !0));
                  });
                  var l = null;
                  !(function e() {
                    l !== window.location.pathname &&
                      ((l = window.location.pathname),
                      Promise.all([
                        NAPI.request("scraper.getServiceConfig"),
                        NAPI.request("scraper.getScenarioConfig"),
                      ])
                        .then((e) => {
                          if (a) return;
                          let t = e[0],
                          ...
                          (u.credentials = {
                            username:
                              t.login || (t.arguments && t.arguments.login),
                            password:
                              t.password ||
                              (t.arguments && t.arguments.password),
                          }),
                            (u.url = t.url),
                            (u.values = i(
                              "string" == typeof t.arguments
                                ? JSON.parse(window.atob(t.arguments))
                                : t.arguments
                            )),
                            (u.scenario = n.scenario),
                            (u.mode =
                              n.mode ||
                              (u.values && Object.keys(u.values).length > 0
                                ? "set"
                                : "get")),
                            (o = new s(
                              u.scenario,
            ...
            21: [
              function (e, t, n) {
                ...
                class f {
                    ...
                    (this.actions = e.actions || {}),
                      ...
                      (this.output = {
                        ...
                        isValid: function (e) {
                          return (
                            !!e.target &&
                            -1 != typeof this.keys.indexOf(e.target)
                          );
                        },
                      }),
                      (this.autoLogin =
                        !e.metadata || "login_none" !== e.metadata.login),
                      (this.features =
                      ...
                      (this._readyPromise = NAPI.request(
                        "scraper.tmpStorage.getItem",
                        { key: this._injectPath + "_avast_scraper_lastAction" }
                      )
                        .catch((e) =>
                          localStorage.getItem(
                            this._injectPath + "_avast_scraper_lastAction"
                          )
                        )
                        .then((e) => {
                          var t = e;
                          "+LOGIN" === t
                            ? ((t = null), (this.preventLogin = !0))
                            : (this.preventLogin = !1),
                    ...
                    return new Promise((t, n) => {
                      NAPI.once("scraper.captchaSolved", (e) => {
                        ...
                        NAPI.request("scraper.captcha", e).then((e) => {
                          e &&
                            e.data &&
                            (NAPI.off("scraper.captchaSolved", t), t(e));
                        });
                    });
                  }
                  run(e) {
                    this._readyPromise.then(() => {
                      ...
                      (this.stage = f.Stage.GET),
                        this.timer.on(s.Event.END, () => {
                          t.disconnect(),
                            (this.stage != f.Stage.END &&
                              (this.onDocumentChange(), this.timer.paused())) ||
                              this.reportResult();
                        }),
                        ...
                        this.timer.on(s.Event.CONTINUE, (e) => {
                          this.onDocumentChange(e),
                            this.timer.expired() &&
                              this.timer.forward(s.Event.END);
                        }),
                        this.timer.start(e),
                        t.observe(document, {
                          childList: !0,
                  ...
                  reportResult(e) {
                    if (
                      (window == window.top || this.hasAnythingToDo()) &&
                      !this._resultReported
                    )
                      if (
                        ((this._resultReported = !0),
                        !(
                          this.stage == f.Stage.END && this.failures.length > 0
                        ) ||
                          (null !== this.verified && this.features.verify))
                      )
                        if (this.stage == f.Stage.END || e) {
                          ...
                          !0 === this.verified
                            ...
                            : !1 === this.verified
                            ? (t.verified = this.verified)
                            : ((t.message = `Scenario continues on another page. Original page: ${d(
                                this.initUrl
                              )}`),
                              NAPI.request("scraper.result", t),
                              setTimeout(() => {}, 8e3));
                  ...
                  onDocumentChange(e) {
                    if (this.stage && !this.timer.paused()) {
                      ...
                      do {
                        var n = (r =
                          void 0 !== e ? e : this[this.stage]()).next();
                        if (!n.done)
                          return void ("object" == typeof n.value &&
                          "function" == typeof n.value.then
                  ...
                  actionsForUrl(e) {
                    ...
                    return (
                      Object.keys(this.actions).forEach((n) => {
                        n.endsWith(":*") &&
                          e.startsWith(n.substr(0, n.length - 2)) &&
                          n.length > t.length &&
                          (t = n);
                      }),
                  ...
                  waitForElementToDisplay(e, t) {
                    return new Promise((n, r) => {
                      ...
                      if (new Date().getTime() > t)
                        return (
                          m(
                            `Element with xpath: ${e} not found in timeout (${t} ms).`
                          ),
                          void r()
                        );
                      i
                        ? n(i)
                        : setTimeout(
                            () => n(this.waitForElementToDisplay(e, t)),
                            500
                          );
                    });
                  }
                  ...
                  *processGetStage() {
                    for (
                      var e = i
                          .trim(
                            this.actionsForUrl(d(this.initUrl)) || [],
                            this.lastScenarioAction
                          )
                          .filter(
                            (e) => this.output.isValid(e) && "set" !== e.mode
                          ),
                        t = e.reduce(function (e, t) {
                          return (
                            t.target &&
                              -1 == e.indexOf(t.target) &&
                              e.push(t.target),
                            e
                          );
                        }, []),
                      ...
                      if (null !== r) {
                        ...
                        null !== s && (this.output.values[r.target] = s),
                          void 0 === this.output.initial[r.target] && null !== s
                            ...
                            : this.output.initial[r.target] !=
                                this.output.values[r.target] && ++n;
                      }
                    }
                  ...
                  *processLoginStage() {
                    if (!this.credentials || this.preventLogin)
                      return f.Stage.ACTIONS;
                    for (
                      var e, t = !1, n = !1, i = r.XForm.search(), s = 0;
                      s < i.length;
                      ++s
                    )
                      if (
                        (e = h(i[s], this.credentials)).length > 0 &&
                        this.autoLogin
                      ) {
                        ...
                        if (
                          i[s].submitButton &&
                          (i[s].submitButton.element.click(), yield 100, t)
                        ) {
                          for (
                            m((Date.now() % 1e5) / 1e3, "unloading"), o = 300;
                            !n && !i[s].hidden && --o > 0;
                        ...
                        if (
                          (a = e.find((e) => e.element.form)) &&
                          (a.element.form.submit(), yield 100, t)
                        ) {
                          for (o = 300; !n && !i[s].hidden && --o > 0; )
                            yield 100;
                          if (o > 0) {
                    ...
                    return (
                      ...
                      window.removeEventListener("beforeunload", l, !0),
                      f.Stage.ACTIONS
                    );
                    function l(e) {
                  ...
                  *processActionStage() {
                    var e = d(this.initUrl),
                      t = i.trim(
                        this.actionsForUrl(e) || [],
                        this.lastInstanceAction
                      ),
                      n = !1,
                      r = 0;
                    function s() {
                    ...
                    for (
                      ...
                      switch (
                        (l == f._ActionResult.PROMISE &&
                          ...
                          yield u.promise),
                        l != f._ActionResult.WAIT ||
                          this.timer.expired() ||
                          (yield 50, (l = this.performAction(u))),
                        l)
                      ) {
                  ...
                  *processEndStage() {
                  ...
                  performGetAction(e) {
                    ...
                    if ("object" == typeof e.value)
                      return void 0 !== e.value[t]
                        ? e.value[t]
                        : (this.failures.push(e.xpath), null);
                    ...
                    if (
                      ...
                      var s = new r.XElement(i),
                        o = (this.actionsForUrl(d(this.initUrl)) || []).find(
                          (e) => s.matches(e.xpath)
                        );
                  ...
                  performAction(e) {
                    ...
                    if (e.mode && e.mode !== this.mode)
                      return f._ActionResult.SKIP;
                    if (
                      ("get" != this.mode && this.input.isValid(e)) ||
                      "change" === e.event
                    ) {
                      if (e.allXElements)
                        return (
                          e.xelement != e.checkedXElement &&
                            e.xelement.element.click(),
                      ...
                      if ("radio" === e.xelement.getProperty("type")) n = !0;
                        ...
                        if (e.target && e.target.startsWith("$"))
                          return (
                            (e.promise = NAPI.request(
                              "scraper.tmpStorage.getItem",
                              { key: e.target }
                            )
                              .then(
                                (t) => (
                                  u(e.xelement, t), f._ActionResult.SUCCESS
                                )
                              )
                              .catch(
                                (e) => (
                        ...
                        if (
                          ((n =
                            void 0 !== this.input.values[e.target]
                              ? this.input.values[e.target]
                              : e.param.value),
                    ...
                    switch (e.event) {
                      case "click":
                        return (
                          this.clickElement(e.xelement.element),
                          f._ActionResult.SUCCESS
                        );
                      case "clickAndQuit":
                        return (
                      ...
                      case "navigate":
                        return (
                          window.location.href != e.param.href &&
                          ((window.location.href = e.param.href),
                          f._ActionResult.SUCCESS)
                        );
                      case "quitok":
                      ...
                      case "quitfail":
                        return (
                          this.failures.push(
                            "Precondition verification failed: element " +
                              e.xpath +
                              " found"
                          ),
                          (this.verified = !1),
                      ...
                      case "verifyok":
                        return (
                          e.xelement
                            ? (this.failures = [])
                            : this.failures.push(
                                "Result verification failed: element " +
                                  e.xpath +
                                  " not found"
                              ),
                          (this.verified = !!e.xelement),
                          e.param &&
                            e.param.emailVerificationRequired &&
                            (this.emailVerificationRequired = !0),
                          f._ActionResult.QUIT
                        );
                      case "verifyfail":
                        return (
                      ...
                      case "login":
                        ...
                        if ((a || (a = s.find((e) => e.isLogin)), !a)) {
                          if (0 == s.length)
                            return (
                              this.failures.push(
                                "Cannot find login form for " + e.xpath
                              ),
                              f._ActionResult.ERROR
                            );
                          a = s[0];
                        ...
                        return 0 == h(a, this.credentials, !0)
                          ? (this.failures.push(
                              "Cannot fill login credentials for " + e.xpath
                            ),
                            f._ActionResult.ERROR)
                          : (e.xelement.element.click(),
                            f._ActionResult.SUCCESS);
                      case "simplecaptcha":
                        if (
                          "HTMLImageElement" ===
                          e.xelement.element.constructor.name
                        )
                          return (d = r.XElement.query(
                            e.param.setXPath,
                            document,
                            !0
                          ))
                            ...
                            : (this.failures.push(
                              ...
                              f._ActionResult.ERROR);
                        if (
                          (e.xelement.element.classList.contains(
                            "g-recaptcha"
                          ) &&
                            Element.prototype.hasAttribute.call(
                              e.xelement.element,
                              "data-sitekey"
                            )) ||
                          e.xelement.element.querySelector(
                          ...
                          var c = Element.prototype.getAttribute.call(
                            e.xelement.element,
                            "data-callback"
                          );
                          return (
                        ...
                        return (
                          this.failures.push(
                            "unknown captcha type for " + e.xpath
                          ),
                          f._ActionResult.ERROR
                        );
                      case "captcha":
                            ...
                            ? ((d = r.XInput.copyFrom(d)),
                              (e.promise = o(e.xelement.element)
                                ...
                                .then((t) => {
                                  let n = t.data;
                                  return (
                                    e.param.caseSensitive &&
                                    "uppercase" === e.param.caseSensitive
                                      ? (n = n.toUpperCase())
                                      : e.param.caseSensitive &&
                                        "lowercase" === e.param.caseSensitive &&
                                        (n = n.toLowerCase()),
                                    u(d, n),
                                    f._ActionResult.SUCCESS
                                  );
                        ...
                        if (
                          ...
                          d = r.XInput.copyFrom(d);
                          var m = Element.prototype.getAttribute.call(
                            e.xelement.element,
                            "data-sitekey"
                          );
                          if (!m) {
                            var g = e.xelement.element
                              .querySelector('iframe[src*="/recaptcha/api"]')
                              .src.match(/[?&]k[=]([^&]+)/);
                            if (!g)
                              return (
                                this.failures.push(
                                  "Cannot google key in reCaptcha iframe"
                                ),
                                f._ActionResult.ERROR
                              );
                            m = g[1];
                          ...
                          return (
                            (e.promise = this.resolveCaptcha({
                              ...
                              .then((t) => {
                                u(d, t.data);
                                var n = Element.prototype.getAttribute.call(
                                  e.xelement.element,
                                  "data-callback"
                                );
                                return (
                      ...
                      case "listselect":
                        ...
                        if (e.param && e.param.setXPath) {
                          if (
                            ...
                            return (
                              this.failures.push(
                                "cannot find clickable element from " +
                                  e.xpath +
                                  " (" +
                                  e.param.setXPath +
                                  ")"
                      ...
                      case "copyurl":
                        ...
                        return (
                          (i =
                            e.param && !e.param.fullPath
                              ? window.location.pathname
                              : window.location.href),
                          NAPI.request("scraper.tmpStorage.setItem", {
                            key:
                              e.param && e.param.target
                                ? e.param.target
                                : "$URL",
                            value: i,
                          }),
                      ...
                      case "scrapeHTML":
                        ...
                        return (
                          NAPI.request("scraper.scrapeHTML.result", {
                            scrape: _,
                          }),
                          f._ActionResult.SUCCESS
                        );
  ...
  (() => {
    ...
    var O,
      M = (O = /[^.]+$/.exec((I && I.keys && I.keys.IE_PROTO) || ""))
        ? "Symbol(src)_1." + O
        : "";
    const D = function (e) {
      return !!M && M in e;
    ...
    (ee.prototype.clear = W),
      (ee.prototype.delete = z),
      (ee.prototype.get = $),
      (ee.prototype.has = Z),
      (ee.prototype.set = Q);
    const te = ee;
    ...
    const Ue = new (class {
      ...
      ke = {
        ...
        "scraper.result": async (e, t) => {
          t.verified &&
            Ue.runtime.sendMessage({ message: "scraperFinished", data: t });
        },
      };
    window.app = {
      syncCall(e, t) {},
